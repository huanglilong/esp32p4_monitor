#!/usr/bin/env python3
"""
ulog_to_audio.py — Extract AAC audio from PX4 ULog (.ulg) files.
...
Usage:
    ...
    python3 ulog_to_audio.py log.ulg -o output.aac

    # Batch extract from all .ulg files in a directory
    python3 ulog_to_audio.py /path/to/logs/ -o /path/to/output/

...
| SystemMonitor | `drivers/system_monitor/` | Per-core CPU busy% (via idle task runtime, no scheduler suspend) + heap/PSRAM 采样, system_stats uORB, ESP_LOG 摘要, Web API, 资源异常告警 (CPU>90% / Memory>80%) | _latest_mutex + _alert_mutex |

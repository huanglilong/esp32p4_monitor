...
#define SYSTEM_STATS_FORMAT_STR "system_stats:uint64_t timestamp;uint32_t core0_cpu_pct;uint32_t core1_cpu_pct;uint32_t free_internal;uint32_t free_psram;uint32_t min_free_internal;uint32_t min_free_psram;uint32_t task_count;uint32_t total_cpu_pct;"

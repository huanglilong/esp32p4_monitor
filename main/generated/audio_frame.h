...
#define AUDIO_FRAME_FORMAT_STR "audio_frame:uint64_t timestamp;uint32_t frame_index;uint16_t sample_rate;uint8_t channel;uint8_t bits_per_sample;uint16_t aac_size;uint8_t[1536] aac_data;uint8_t[6] _padding0;"

...
"if(j.running&&!ulogTimer)ulogTimer=setInterval(loadUlogStatus,2000);"
"else if(!j.running&&ulogTimer){clearInterval(ulogTimer);ulogTimer=null;}"
"}"
"catch(e){}}"
...
"clearInterval(ulogTimer);ulogTimer=null;"
